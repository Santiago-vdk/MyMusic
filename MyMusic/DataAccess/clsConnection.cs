...
namespace DataAccess
{
    public class clsConnection
    {
        ...
        public clsConnection()
        {
            ...
            conn = new SqlConnection("Server=tcp:mymusic.database.windows.net,1433;Data Source=mymibhjbjbuhbihbusic.database.windows.net;Initial Catalog=myMusic;Persist Security Info=False;User ID=David;Password=x100preXD;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
